...
import { mount as text_diff } from '../tools/text/text-diff/view.js';
import { mount as markdown_editor } from '../tools/text/markdown-editor/view.js';
import { mount as regex_tester } from '../tools/developer/regex-tester/view.js';
import { mount as time_zone_planner } from '../tools/travel/time-zone-planner/view.js';
import { mount as budget_planner } from '../tools/finance/budget-planner/view.js';
import { mount as image_cropper } from '../tools/media-files/image-cropper/view.js';
import { mount as chart_builder } from '../tools/data/chart-builder/view.js';
import { mount as audio_trimmer } from '../tools/media-files/audio-trimmer/view.js';
import { mount as flashcards } from '../tools/education/flashcards/view.js';
import { mount as zip_tool } from '../tools/media-files/zip-tool/view.js';
import { mount as quiz_builder } from '../tools/education/quiz-builder/view.js';
import { mount as image_ocr } from '../tools/media-files/image-ocr/view.js';
const toolViews = { 'image-ocr': image_ocr, 'zip-tool': zip_tool, 'quiz-builder': quiz_builder, 'image-cropper': image_cropper, 'chart-builder': chart_builder, 'audio-trimmer': audio_trimmer, 'flashcards': flashcards, 'text-diff': text_diff, 'markdown-editor': markdown_editor, 'regex-tester': regex_tester, 'time-zone-planner': time_zone_planner, 'budget-planner': budget_planner, 'pdf-merger': pdf_merger, 'pdf-extractor': pdf_extractor, 'pdf-organizer': pdf_organizer, 'images-to-pdf': images_to_pdf, 'csv-viewer': csv_viewer, 'qr-generator': qr_generator, 'image-resizer': image_resizer, 'image-converter': image_converter, 'pomodoro': pomodoro, 'stopwatch': stopwatch, 'notes': notes, 'tasks': tasks, 'habit-tracker': habit_tracker, 'bookmarks': bookmarks, 'expense-tracker': expense_tracker, 'csv-json': csv_json, 'jwt-inspector': jwt_inspector, 'slug-generator': slug_generator, 'contrast-checker': contrast_checker, 'date-difference': date_difference, 'statistics-calculator': statistics_calculator, 'resistor-calculator': resistor_calculator, 'bill-splitter': bill_splitter, 'recipe-scaler': recipe_scaler, 'morse-translator': morse_translator, 'percentage-calculator': percentage_calculator, 'discount-calculator': discount_calculator, 'compound-interest': compound_interest, 'loan-calculator': loan_calculator, 'bmi-calculator': bmi_calculator, 'aspect-ratio': aspect_ratio, 'color-converter': color_converter, 'hash-calculator': hash_calculator, 'url-inspector': url_inspector, 'number-base': number_base, 'encoding-converter': encoding_converter, 'uuid-generator': uuid_generator, 'timestamp-converter': timestamp_converter, 'unit-converter': unit_converter };
